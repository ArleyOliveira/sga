...
char keymap[numRows][numCols]= // Aqui ̩ feito o "mapa" do teclado, que ṣo as teclas
{
 {'1','2','3','A'},
 {'4','5','6','B'},
 {'7','8','9','C'},
...
byte rowPins[numRows] = {22,24,26,28}; // Pinos digitais onde as linhas esṭo conectadas
byte colPins[numCols] = {30,32,34,36}; // Pinos digitais onde as colunas esṭo conectadas
...
//Variaveis para a comunica̤̣o
String resposta ="";
String codigo = "10";
...
void abrirPortaInterno(){
  abrirPorta();
  delay(2000);
}

void checaBotaoSaidaInterna(){
  if(digitalRead(BTN_SAIDA) == HIGH) {    
       abrirPortaInterno();
  }
}
